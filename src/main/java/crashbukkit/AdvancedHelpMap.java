...
/**
 * Advanced implementation of {@link HelpMap} for Rush servers.
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
public class AdvancedHelpMap implements HelpMap {

    private HelpTopic defaultTopic;
    private final Map<String, HelpTopic> helpTopics;
	private final Map<Class, HelpTopicFactory<Command>> topicFactoryMap;
    private final CrashServer server;
    //private HelpYamlReader yaml;

    public AdvancedHelpMap(CrashServer server) {
    ...
    public List<String> getIgnoredPlugins() {
        return new ArrayList<>(); //.getIgnoredPlugins();
    }

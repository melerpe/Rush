...
public class PacketSpawnObject extends Packet {
	...
	public PacketSpawnObject(Entity en, ObjectType type) {
		this(en, type, 0, 0, 0, 0);
	}

	/** To prevent typos, use inbuilt types ids. */
	public PacketSpawnObject(Entity en, ObjectType type, int throwerId, double speedX, double speedY, double speedZ) {
		super();

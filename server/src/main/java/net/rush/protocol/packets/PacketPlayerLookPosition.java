...
public class PacketPlayerLookPosition extends PacketPlayerOnGround {
	...
	public PacketPlayerLookPosition(double x, double yOrStance, double stanceOrY, double z, float yaw, float pitch, boolean onGround) {
		super(onGround);
		this.x = x;
